    ...
    >
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <aside
          ...
          tabindex="-1"
          class="fixed inset-y-0 z-10 flex-shrink-0 w-64 bg-white border-r lg:static dark:border-primary-darker dark:bg-darker focus:outline-none"
        >
            ...
            <div class="relative flex items-center justify-center flex-shrink-0 px-2 py-4 space-x-4">
              ...
              <div class="" x-data="{ open: false }">
                ...
                >
                  ...
                  <img class="w-12 h-12 rounded-full" src="../build/images/avatar.jpg" alt="Ahmed Kamel" />
                </button>
        ...
        <section
          ...
          tabindex="-1"
          class="fixed inset-y-0 z-10 flex-shrink-0 w-64 bg-white border-r dark:border-primary-darker dark:bg-darker lg:static focus:outline-none"
          aria-labelledby="secondSidebarHeader"
        >
          <div class="flex flex-col h-screen">
            <!-- Panel header -->
            <div class="flex-shrink-0">
              <div class="px-4 pt-4 border-b dark:border-primary-darker">
                <h2 id="secondSidebarHeader" class="pb-4 font-semibold">Header</h2>
              </div>
            </div>
        ...
        <div class="fixed flex items-center space-x-4 top-5 right-10 lg:hidden">
          ...
          <button
            ...
            class="p-1 transition-colors duration-200 rounded-md text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark focus:outline-none focus:ring"
          >
            <span class="sr-only">Toggle second sidebar panel</span>
            <span aria-hidden="true">
              <svg
