      ...
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{ asset('assets/build/images/avatar.jpg') }}" alt="Mohamad Gifahri Addiansyah" />
                  </button>
          ...
          <main>
            ...
            <!-- Content -->
            <div align="center" class="card bg-dark text-white">
              <img src="assets/img/homepage.jpeg" class="card-img" alt="...">
